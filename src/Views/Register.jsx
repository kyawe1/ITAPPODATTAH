...
export default function Register() {
    ...
    return (
        <Box className=" flex place-items-center h-screen box-border overflow-auto ">
            <Box className="w-4/6 max-sm:hidden">
            ...
            <Box className="bg-sky-500 py-4 px-10 mx-auto w-2/6 max-sm:w-full  lg:h-screen  border-1 border-gray-50 shadow">
                ...
                <Box>
                    ...
                    <h2 className="text-center text-xl font-semibold">Register Page</h2>
                </Box>
                ...
                <Container className="lg:my-2">
                    ...
                    <input type="password" className="w-full rounded border border-1 p-2" onChange={confirmPasswordOnChange} value={confirmPassword} placeholder="Confirm Password"></input>
                </Container>
                <Container>
                    <button className="rounded p-2 mx-auto my-1 block w-3/4 bg-sky-400" onClick={ajax}>Register</button>
                </Container>
            </Box>
